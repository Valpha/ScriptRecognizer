...
public class DataManager {
    ...
    public void readCsv(String filename) throws IOException {
        ...
        parser = new CSVParserBuilder()
                ...
                .build();
        final CSVReader reader = new CSVReaderBuilder(new InputStreamReader(new FileInputStream(filename), Charset.forName("GB2312")))
                .withSkipLines(0)
    ...
    public void writeCsv(String filename) throws IOException {
        ...
        Writer writer = new OutputStreamWriter(new FileOutputStream(filename), Charset.forName("GB2312"));
